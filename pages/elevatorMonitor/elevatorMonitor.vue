		...
		<view class="ele-bot">
			<view class="ele-bot-top">
				<view class="ele-bot-top-xl">
					<view class="ele-bot-top-xl-ad1">
						重庆<image src="../../static/image/wxj/xia.png" mode=""></image>
					</view>
					<view class="ele-bot-top-xl-ad2">
